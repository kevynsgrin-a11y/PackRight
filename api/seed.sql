...
REPLACE INTO airlines (
  ...
  ('wn', 'southwest-airlines', 'Southwest Airlines', 'WN', 16, 13.5, 8.5, 24, 16, 10, NULL, 50, 62, 'https://www.southwest.com/help/baggage', 'Southwest Airlines - Baggage', NULL, NULL, NULL, 'US domestic', 'USD', 'unverified', 'Dimensions carried over unchanged from the initial MVP seed (16 x 13.5 x 8.5), which was already in longest-to-shortest order. An earlier revision of this file recorded 16.25 x 13.5 x 8 while claiming the record had only been reordered; that was wrong on both counts and the original values have been restored. Not yet checked against the airline source. Southwest''s checked-bag allowance changed during 2025 and this record is a priority for steward review.', datetime('now')),
